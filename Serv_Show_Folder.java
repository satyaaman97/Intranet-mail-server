...
// Source File Name:   Serv_Show_Folder.java
...
public class Serv_Show_Folder extends HttpServlet
{

    public Serv_Show_Folder()
    {
        sos = null;
        col = 1;
    }
	...
	con=ConnectionProvider.getConnection();
            ...
            newfol = httpservletrequest.getParameter("foldval");
            ResultSet resultset = st.executeQuery("select mid,mfrom,sub,mcc,mailst,maildate from newfolder where folder='" + newfol + "'");
            ...
            sos.println("<h2><i>Contents of folder&nbsp;&nbsp;</i>" + newfol + "</h2><br><br><br><br>");
